// All 12 tac ops across 4 archetypes — use this as reference when writing populate scripts.
// Each team uses 2 archetypes (6 tac ops). Copy the relevant rule() calls verbatim.
//
// Usage in a populate script:
//   rule('tac_op', 'ARCHETYPE_NAME', 'TAC OP NAME', 0, `...description...`);

// ── SEEK-DESTROY ──────────────────────────────────────────────────────────────

export const SEEK_DESTROY = [
  {
    name: 'SWEEP & CLEAR',
    description: `Archetype: SEEK-DESTROY
...
export const SECURITY = [
  {
    name: 'PLANT BANNER',
    description: `Archetype: SECURITY
...
export const INFILTRATION = [
  {
    name: 'TRACK ENEMY',
    description: `Archetype: INFILTRATION
